...
public class Ids 
{
    ...
    public static final int ingotCopper_default = 5002;
    public static int ingotTin;
    public static final int ingotTin_default = 5003;
    public static int ingotLead;
    public static final int ingotLead_default = 5004;
    public static int ingotBronze;
    public static final int ingotBronze_default = 5005;
    public static int blankBronze;
    public static final int blankBronze_default = 5006;
    public static int gemRuby;
    public static final int gemRuby_default = 5007;
    public static int gemSapphire;
    public static final int gemSapphire_default = 5008;
    //----Swords----//
    public static int swordSilver;
    public static final int swordSilver_default = 5010;
    public static int swordBronze;
    public static final int swordBronze_default = 5011;
    public static int swordRuby;
    ...
    public static final int pickaxeBronze_default = 5021;
    public static int pickaxeRuby;
    ...
    public static final int shovelBronze_default = 5031;
    public static int shovelRuby;
    ...
    public static final int axeBronze_default = 5041;
    public static int axeRuby;
    ...
    public static final int hoeBronze_default = 5051;
    public static int hoeRuby;
    ...
    public static final int helmetBronze_default = 5061;
    public static int helmetRuby;
    ...
    public static final int chestplateBronze_default = 5071;
    public static int chestplateRuby;
    public static final int chestplateRuby_default = 5072;
    public static int chestplateSapphire;
    public static final int chestplateSapphire_default = 5073;
    //----Leggings----//
    public static int leggingsSilver;
    public static final int leggingsSilver_default = 5080;
    public static int leggingsBronze;
    public static final int leggingsBronze_default = 5081;
    public static int leggingsRuby;
    public static final int leggingsRuby_default = 5082;
    public static int leggingsSapphire;
    public static final int leggingsSapphire_default = 5083;
    //----Boots----//
    public static int bootsSilver;
    public static final int bootsSilver_default = 5090;
    public static int bootsBronze;
    public static final int bootsBronze_default = 5091;
    public static int bootsRuby;
	...
	public static final int oreSilver_default = 500;
	public static int oreCopper;
	public static final int oreCopper_default = 501;
	public static int oreTin;
	public static final int oreTin_default = 502;
	public static int oreLead;
	public static final int oreLead_default = 503;
	public static int oreRuby;
	...
	//----RedRock----//
	public static int redRock;
	public static final int redRock_default = 530;
	//----Stairs----//
	public static int stairRedRockCobble;
	...
	public static int potionCombiner_active;
	public static final int potionCombiner_active_default = 602;
}
