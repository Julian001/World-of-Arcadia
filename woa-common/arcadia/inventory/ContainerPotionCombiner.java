...
import arcadia.SlotPotionCombiner;
import arcadia.tileentity.TileEntityPotionCombiner;

public class ContainerPotionCombiner extends Container
{
	private TileEntityPotionCombiner blast;
	private int dualCookTime;
	private int dualBurnTime;
	private int lastItemBurnTime;
	
	public ContainerPotionCombiner(InventoryPlayer inventoryplayer, TileEntityPotionCombiner tileentity)
	{
	         dualCookTime = 0;
	         dualBurnTime = 0;
	         lastItemBurnTime = 0;
	         blast = tileentity;
	         this.addSlotToContainer(new Slot(tileentity, 0, 42, 17));
	         this.addSlotToContainer(new Slot(tileentity, 1, 70, 17));
	         this.addSlotToContainer(new Slot(tileentity, 2, 56, 53));
	         this.addSlotToContainer(new SlotPotionCombiner(inventoryplayer.player, tileentity, 3, 116, 35));
	         for (int i = 0; i < 3; i++)
	         {
	                 for (int k = 0; k < 9; k++)
	                 {
