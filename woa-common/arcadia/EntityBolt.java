...
public class EntityBolt extends Entity implements IProjectile
{
	...
	public void onUpdate()
	{
	         ...
	         if (this.inGround)
	         {
	                 //this.playSound("Bow-", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
	                 this.setDead();
	         }
	         else
	         {
	                 ...
	                 if (movingobjectposition != null)
	                 {
	                         if (movingobjectposition.entityHit != null)
	                         {
	                                 ...
	                                 {
	                                         damagesource = causeArrowDamage( this );
	                                 }
	                                 else
	                                 {
	                 ...
	                 // this.motionY -= (double)f1; //<-- this is gravity I presume. I want to get rid of it.
	                 this.setPosition(this.posX, this.posY, this.posZ);
	                 this.doBlockCollisions();
	         }
	}
	
	private DamageSource causeArrowDamage(Entity par0Entity)
	{
	         return (new EntityDamageSourceIndirect("bullet", this, par0Entity)).setProjectile();
	}
	/**
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
	{
	         if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
	         {
	                 ...
	                 if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(arcadia.bolt, 1)))
	                 {
	                         flag = false;
	                 }
	                 if (flag)
