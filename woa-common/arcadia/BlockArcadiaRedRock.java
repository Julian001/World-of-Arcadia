...
public class BlockArcadiaRedRock extends BlockArcadia {

	public float hardness = 1F;
	
	public BlockArcadiaRedRock(int id, Material material) {
		super(id, material);
       ...
       public int damageDropped(int metadata)
	    ...
	    // TODO
	    public  float Hardness(int metadata){
			if(metadata == 0){
				return hardness = 1.3F;}
			if(metadata == 1){
				return hardness = 1.8F;}
			if(metadata == 2){
