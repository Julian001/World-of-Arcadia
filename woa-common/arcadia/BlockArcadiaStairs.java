...
public class BlockArcadiaStairs extends Block
{
    ...
    protected BlockArcadiaStairs(int par1, Block par2Block, int par3)
    {
    ...
    {
        return par0 > 0 && Block.blocksList[par0] instanceof BlockArcadiaStairs;
    }
