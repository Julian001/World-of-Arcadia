...
public class ItemArcadiaBagSmall extends ItemArcadia
{
	public ItemArcadiaBagSmall(int id)
	{
		super(id);
		this.maxStackSize = 1;
	...
	*/
	...
	player.getHeldItem() != null && player.getHeldItem().getItem() instanceof ItemArcadiaBagSmall)
	{
