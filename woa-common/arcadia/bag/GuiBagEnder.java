...
public class GuiBagEnder extends GuiContainer
{
	...
	*/
	...
	public GuiBagEnder(ContainerBagEnder container)
	{
	         super(container);
	...
	{
	         this.fontRenderer.drawString("Ender Bag", this.xSize / 2 - 102, -1, 4210752);
