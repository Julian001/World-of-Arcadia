...
public class SlotArcadiaBag extends Slot
{
public SlotArcadiaBag(IInventory par1iInventory, int par2, int par3, int par4)
{
...
return !(itemstack.getItem() instanceof ItemArcadiaBag) || !(itemstack.getItem() instanceof ItemArcadiaBagMedium) || !(itemstack.getItem() instanceof ItemArcadiaBagSmall);
}
}
