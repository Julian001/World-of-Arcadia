...
public class ContainerBagArcadia extends Container
{
	...
	public final InventoryBagArcadia inventory;
	...
	* InventoryItem.INV_SIZE and if we ever change it, the Container updates automatically. */
	private static final int INV_START = InventoryBagArcadia.INV_SIZE, INV_END = INV_START+26,
...
public ContainerBagArcadia(EntityPlayer par1Player, InventoryPlayer inventoryPlayer, InventoryBagArcadia inventoryItem)
{
	...
	for (i = 0; i < InventoryBagArcadia.INV_SIZE; ++i)
	{
	...
	*/
	...
	((InventoryBagArcadia) inventory).writeToNBT(this.containerstack.getTagCompound());
	}
