...
public class ItemArcadiaBagMedium extends ItemArcadia
{
	public ItemArcadiaBagMedium(int id)
	{
		super(id);
		this.maxStackSize = 1;
	...
	*/
	...
	player.getHeldItem() != null && player.getHeldItem().getItem() instanceof ItemArcadiaBagMedium)
	{
